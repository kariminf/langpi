...
public class CsSWEliminator implements SWEliminator {

	private List<String> stopList = getStopList("czech.stop");
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = CsSWEliminator.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		CsSWEliminator eliminator = new CsSWEliminator();
