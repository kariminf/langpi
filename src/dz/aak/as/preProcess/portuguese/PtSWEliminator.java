...
package dz.aak.as.preProcess.portuguese;
...
public class PtSWEliminator implements SWEliminator {

	private final String  pathToStopWords = "/ressources/stopWords/portuguese.stop";
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = PtSWEliminator.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		SWEliminator eliminator = new PtSWEliminator();
