...
package kariminf.langpi.basic.catalan;
...
public class CaSWEliminator implements SWEliminator {
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = CatalanAnalyzer.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		SWEliminator eliminator = new CaSWEliminator();
