...
public class HuSWEliminator implements SWEliminator {

	private final String  pathToStopWords = "/ressources/stopWords/hungarian.stop";
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = HuSWEliminator.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		HuSWEliminator eliminator = new HuSWEliminator();
