...
public class TrSWEliminator implements SWEliminator {

	private final String  pathToStopWords = "/ressources/stopWords/turkish.stop";
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = TrSWEliminator.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		SWEliminator eliminator = new TrSWEliminator();
