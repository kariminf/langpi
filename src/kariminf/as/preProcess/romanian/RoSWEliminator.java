...
public class RoSWEliminator implements SWEliminator {

	private final String  pathToStopWords = "/ressources/stopWords/romanian.stop";
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = RoSWEliminator.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		RoSWEliminator eliminator = new RoSWEliminator();
