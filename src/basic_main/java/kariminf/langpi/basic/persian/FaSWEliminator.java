...
package kariminf.langpi.basic.persian;
...
public class FaSWEliminator implements SWEliminator {
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = PersianAnalyzer.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		SWEliminator eliminator = new FaSWEliminator();
