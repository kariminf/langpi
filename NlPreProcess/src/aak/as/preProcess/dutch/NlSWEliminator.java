...
public class NlSWEliminator implements SWEliminator {

	private List<String> stopList = getStopList("dutch.stop");
	...
	private static List<String> getStopList(String path) {
	    ...
	    try {
	    	...
	    	InputStream in = NlSWEliminator.class.getResourceAsStream(path);
	...
	public static void main(String[] args) {
		...
		tstList.add("Junghuhns");
		tstList.add("vader");
		tstList.add("een");
		tstList.add("ongediplomeerd");
		tstList.add("mijnarts");
		tstList.add("wilde");
		tstList.add("dat");
		tstList.add("zijn");
		tstList.add("zoon");
		...
		NlSWEliminator eliminator = new NlSWEliminator();
